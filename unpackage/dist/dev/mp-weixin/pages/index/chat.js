      ...
      (function (module, exports, __webpack_require__) {
        ...
        (function (uni) {
          ...
          var _default = {
            ...
            onUnload: function onUnload() { // console.log('onUnload');
              // this.time1 = '0';
              // this.huoqu_xiaoxi_list()
              this.$http.post({
            ...
            methods: {
              ...
              onOpenDoc: function onOpenDoc(src) {
                ...
                plus.io.resolveLocalFileSystemURL(path, function (entry) {
                  entry.file(function (file) {
                    ...
                    reader.onloadend = function (e) {
                      ...
                      that.up_luyin(e.target.result); // that.dataURL2Audio(e.target.result, function(entry){
