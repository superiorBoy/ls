...
/* WEBPACK VAR INJECTION */(function (uni) {
                ...
                var recorderManager = uni.getRecorderManager(); var innerAudioContext = uni.createInnerAudioContext(); innerAudioContext.autoplay = true; var emotion = function emotion() { __webpack_require__.e(/*! require.ensure | components/bkhumor-emoji/index */ "components/bkhumor-emoji/index").then((function () { return resolve(__webpack_require__(/*! @/components/bkhumor-emoji/index.vue */ 1184)); }).bind(null, __webpack_require__)).catch(__webpack_require__.oe); }; var uParse = function uParse() { Promise.all(/*! require.ensure | components/feng-parse/parse */[__webpack_require__.e("common/vendor"), __webpack_require__.e("components/feng-parse/parse")]).then((function () { return resolve(__webpack_require__(/*! @/components/feng-parse/parse.vue */ 1163)); }).bind(null, __webpack_require__)).catch(__webpack_require__.oe); }; var lfile = function lfile() { __webpack_require__.e(/*! require.ensure | components/l-file/l-file */ "components/l-file/l-file").then((function () { return resolve(__webpack_require__(/*! @/components/l-file/l-file.vue */ 1177)); }).bind(null, __webpack_require__)).catch(__webpack_require__.oe); }; var _default = {
                    ...
                    }, created: function created() { }, components: { emotion: emotion, uParse: uParse, lfile: lfile }, onLoad: function onLoad(option) {
                        var _this = this; this.userid = option.userid; this.huanying(); // 查看消息保留条数
                    ...
                    }, onShow: function onShow() { var that = this; setTimeout(function () { that.app_lianjie()}, 1000); }, onReady: function onReady() { }, onHide: function onHide() {// 	this.$http
                        // 		.post({
                    ...
                    onPullDownRefresh: function onPullDownRefresh() {// this.is_xiala = true;
                        ...
                        onPageScroll: function onPageScroll(res) {
                            var that = this; if (res.scrollTop == 0) { this.is_xiala = true; if (this.is_all) { uni.showToast({ title: '没有更多内容了', duration: 2000, icon: 'none' }); uni.stopPullDownRefresh(); } else { uni.showLoading({ title: '加载中', mask: true }); this.page++; this.huoqu_xiaoxi_list(); } } // console.log(res.scrollTop)
                        ...
                        dian_luyin: function dian_luyin() {
                            var _this4 = this; var that = this; this.is_yuyin = true; this.timer = setInterval(function () {
                            _this4.intervalTime += 0.5; if (_this4.intervalTime >= 0.5 && !_this4.isRecord) {//如果用户录制的时间太短,就不会去开启录音, 因为有个bug: recorderManager.stop()在短时间内开启在关闭的话,实际上他还在不停地录音,不知道你们有没有遇到过
                                console.log('开始录音'); _this4.isRecord = true; _this4.intervalTime = 0; recorderManager.start({ format: 'mp3' });
                            } // console.log(this.intervalTime)
                                if (_this4.intervalTime >= 60) { uni.showToast({ title: '不得超过60秒', duration: 2000, icon: 'none' }); that.songkai(); }
                            }, 500);
                        }, yiru: function yiru() { this.on_yuyin = false; }, moveStop: function moveStop(e) { console.log(e.touches[0].clientY); if (e.touches[0].clientY < 650) { this.is_quxiao = true; } else { this.is_quxiao = false; } }, songkai: function songkai() {
                            var _this5 = this; var that = this; console.log('songkai', this.is_quxiao); if (this.is_quxiao) { console.log('已取消录音'); } else {
                                if (this.intervalTime <= 0.5) { console.log('录音太短了!!!'); } clearInterval(this.timer); if (this.isRecord) {
                                    setTimeout(function () {
                                        recorderManager.stop(); _this5.isRecord = false; // var data = {
                                        // 	content: '',
                                        // 	msgtype: 12,
                            ...
                            _this11.title = res.data.user_to.mobile; _this11.dianhua = res.data.user_to.mobile; _this11.yh_user = res.data.user_to; _this11.zixuncount = res.data.zixuncount; var _loop = function _loop(key) {
                                ...
                                // 	this.is_all = true;
                                // }
                                if (!_this11.is_xiala) { setTimeout(function () { uni.pageScrollTo({ scrollTop: 99999, duration: 0 }); }, 400); } else {
                                    setTimeout(function () {
                                        var info = uni.createSelectorQuery().select('.chat_body'); info.boundingClientRect(function (data) {//data - 各种参数
                                            uni.pageScrollTo({ scrollTop: data.height - that.first_height, duration: 0 });
                                        }).exec();
                                    }, 1000);
                                } that.time1 = res.data.shijian; console.log(that.time1); // 倒计时
                        ...
                        }, huoqu_renzheng: function huoqu_renzheng() { var _this12 = this; this.$http.post({ url: '/mlawyerapi/lawyer/auth', data: { type: 2 } }).then(function (res) { _this12.renzheng = res.data.lawyerauth; }); }
