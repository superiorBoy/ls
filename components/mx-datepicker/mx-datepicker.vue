...
<style  >
	...
	.picker {
		...
		.picker-time {
			width: 630upx - 80upx !important;
			left: ((750upx - 630upx) / 2 + 40upx) !important;
		}
		...
		.picker-calendar {
			...
			.picker-calendar-view {
				...
				.picker-calendar-view-bgbegin,
				.picker-calendar-view-bg,
				.picker-calendar-view-bgend,
				...
				.picker-calendar-view-tips {
					...
					.picker-calendar-view-tips:after {
						content: "";
						position: absolute;
						top: 100%;
						left: 50%;
