		...
		<view class="zi_body ">
			<view class="pay_top">
				<view class="pay_list">
					...
					<text class="hei_30">{{ type == 1 ? '在线咨询' : type == 2 ? '电话咨询' : type == 3 ? '合同文书' : type == 4 ? '诉讼委托' : '见面咨询' }}({{ time }})</text>
				</view>
				<!-- 	<view class="pay_list">
			...
			<view class="pay_btn"><button type="" class="tixian_btn bai_30" @click="save">支付</button></view>
		</view>
	</view>
</template>
