<template>
	<view class="body">
		...
		<view class="zi_body ">
			...
			<view class="shuru">
				<view class="hei_30 tiwen_title">问题描述</view>
				...
				<view class="tiwen_bottom">
					<view class="qian_24 xuan_list xaunleibie">
						...
						<picker mode="selector" :range="fenlei_arry" @change="jiating_change" :range-key="'typename'">
							<view :class="['zhuanchang_xuan', fenlei == '选择类别' ? 'qian_26' : 'hei_26']">{{ fenlei }}</view>
						</picker>
					</view>
				...
				<view class="jiedan_ls">
					...
					<view class="jiedan_bottom hui_22">
						...
						<text class="">
							<image src="@/static/img/zhineng_duihao.png" mode=""></image>
							服务保障
						</text>
						<text class="">
							<image src="@/static/img/zhineng_duihao.png" mode=""></image>
			...
			<view class="tiwen_bottom_btn">
				...
				<view class="qian_24" style="display: flex;justify-content: center;">
					...
					我已阅读并同意
					<navigator url="xieyi"><text class="lv_24">《小虎网络服务协议》</text></navigator>
				</view>
			</view>
		</view>
