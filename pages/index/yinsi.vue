<template>
  <view class="body">
    <view class="head">
      ...
      <view class="head_center hei_38_bold">隐私政策</view>
    ...
    <view class="xieyi_body">
      ...
      (b) 在您使用本应用网络服务，或访问本应用平台网页时，本应用自动接收并记录的您的浏览器 和计算机上的信息，包括但不限于您的IP地址、浏览器的类型、使用的语言、访问日期和时间、软硬件特征信息及您需求的网页记录等数据； <br>
