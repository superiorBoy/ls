...
<view class="zixun_item_top">
	      ...
	      <view class="zixun_item_right">
					<view :class="['',item.zixunstate == 4?'qian_26_bold':'lv_26_bold']">{{ item.zixunstate == 1 ? '未付款':item.zixunstate == 2?'已付款':item.zixunstate == 3?'接单中':item.zixunstate == 4?'已完成':item.zixunstate == 5?'已退款':item.zixunstate ==6?'已取消':'' }}</view>
