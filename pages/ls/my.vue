	...
	<view class="">
		...
		<view class="my_top">
			<view class="my_top_left">
				...
				<view class="my_top_left_r" v-if="is_login">
					...
					<view class="renzheng bai_20" v-if='user.isreal==1'>
						认证律师
					</view>
				</view>
			...
			<view class="my_top_right hei_30_bold" @click="qiehuan">
				切换到用户中心
			</view>
		</view>
		...
		<view class="my_ziliao">
			<view class="my_ziliao_item">
				<view class="my_ziliao_item_top hei_28">
					0
				</view>
				<view class="my_ziliao_item_bottom hei_22">
					关注
				</view>
			</view>
			<view class="my_ziliao_item">
			...
			<view class="my_ziliao_item">
				<view class="my_ziliao_item_top hei_28_b">
					0
				</view>
				<view class="my_ziliao_item_bottom hei_22">
					团队
		...
		<view class="my_bottom">
			<view class="my_guanli">
				...
				<view class="my_title hei_30_bold">
					接单管理
				</view>
