<template>
	<view class="body">
		...
		<view class="xuanze">
			<view class="xuanze_title hei_34_bold">
				选择服务
			</view>
			<view class="xuanze_body">
				<view class="xuanze_item hei_30" :class="xuanze==1?'xuanzhong':''" @click="xuan(1)">
					<view class="jiage">
						￥<text class="hong_38">1800</text> 
					</view>
					<view class="nian">
						1年
					</view>
					<view class="tiyan bai_22">体验</view>
				</view>
          ...
          <view class="haochu">
          	<view class="haochu_title hei_34_bold">
          		加入VIP的好处
          	</view>
			<view class="haochu_list hui_24">
				<view class="haochu_item">
					1.律师排名更前面，主页，咨询页面等排名前面！
				</view>
				<view class="haochu_item">
					2.当地律师首屏展示，显示排名前面！
				</view>
				<view class="haochu_item">
					3.加入网站律师展示广告位，得到更多展示！
				</view>
				<view class="haochu_item">
					4.加入系统订单匹配，自动分配电话咨询订单，获取更多收入！
				</view>
				<view class="haochu_item">
					5.加入系统订单匹配，自动分配在线咨询订单，获取更多收入！
				</view>
				<view class="haochu_item">
					6.加入系统案件委托，优先推送当地的案件，获取更多收入！
				</view>
				<view class="haochu_item">
					7.加入提问系统，优先推送当地提问咨询的人，获取更多收入！
				</view>
		  ...
		  <view class="zhifu">
		  	<view class="zhifu_title hei_34_bold">
		  		选择支付方式
		  	</view>
