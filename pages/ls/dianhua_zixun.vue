	...
	<view class="body">
		...
		<view class="zi_body tab_zi_body">
				...
				<view class="zixun_item" v-for="(item, index) in jilu_list">
					<view class="zixun_item_top">
						<view class="zixun_item_left">
							<view class="zixun_item_tx"><image :src="img_url + item.photourl"></image></view>
						...
						<view class="zixun_r">
							...
							<view class="zixun_dianhua" @click="call(item.phone)">
								<image src="@/static/img/hy_dianhua.png" mode=""></image>
								{{ item.phone }}
							</view>
						</view>
					</view>
			...
			<view class="none_list" v-if="jilu_list.length == 0">
				...
				<view class="none_list_txt qian_26">暂无电话记录</view>
			</view>
		</view>
