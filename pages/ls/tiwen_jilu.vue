			...
			<view class="tiwen_list">
				<view class="tiwen_item" v-for="(item,index) in jilu_list">
					...
					<view class="tiwen_item_center qian_22">
						...
						<view class="tiwen_item_biaoqian" v-if="fenlei.length!=0">
					...
					<view class="huifu_btn">
						<button type="" class="huifu qian_24" @click="xq(item.consultid)">详情</button> <text class="hong_26">奖励{{item.paymoney}}元</text>
					</view>
				</view>
			...
			<view class="tan">
				...
				<view class="tan_list hei_26">
					<view class="tan_list_top">
						<pickerAddress @change="change" class='aaaaaa' @click='dianji'><text class="dizhi">{{dizhi==''?'按地区':dizhi}}</text></pickerAddress>
						<!-- <text>按地区</text> -->
