	...
	<view class="body">
		...
		<view class="zi_body ">
			<view class="xq_body">
				...
				<view class="tiwen_huifu">
					<textarea value="" placeholder="说点什么吧..." class="hei_24" v-model="shuru_txt"/>
				</view>
				<view class="tiwen_huifu_btn">
						...
						<view class="xq_ls">
							<view class="xq_ls_left">
								...
								<view class="xq_ls_name">
									<view class="hei_26_bold xq_ls_name_img">{{item.nickname}}律师 <image src="@/static/img/ls_shiming_yi.png" mode="widthFix"></image></view>
									<view class="qian_22 xq_ls_jieda">已解答<text>{{item.replynum}}</text>次</view>
								</view>
							</view> 
