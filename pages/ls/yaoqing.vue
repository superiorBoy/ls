		...
		<view >
			<view class="head">  
			  <view class="head_back">
				  <image src="@/static/img/back.png" mode="" @click="navigateBack()" v-if="!is_show"></image>
			  </view> 
			...
			<view class="padding_bottom"  v-if="is_show"></view>
			<tabBar :currentPage="currentPage" v-if="is_show"></tabBar>
