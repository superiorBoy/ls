			...
			<view class="xq_body" v-if="xq">
				...
				<view class="xq_body_top">
					<view class="xq_wenti hui_26">
						{{xq.consult.information}}
					</view>
					<view class="tiwen_item_center qian_22">
						<view class="tiwen_item_dizhi">
							<image src="@/static/img/dizhi.png" mode=""></image>{{xq.consult.province}}-{{xq.consult.city}}
						</view>
						<view class="tiwen_item_biaoqian">
							<image src="@/static/img/biaoqian.png" mode=""></image>{{ fenlei[xq.consult.typeid].typename }}
						</view>
						<view class="tiwen_item_shijian">
							<image src="@/static/lsimg/shijian_icon.png" mode=""></image>{{ xq.consult.addtime | timeStamp }}
						</view>
					</view>
				</view>
				...
				<view class="xq_bottom">
					...
					<view class="xq_huifu_txt hui_26">
						...
						<view class="zhuiwen hui_26"  v-if="iten.type==1">
							...
							<view class="zhuiwen_body">{{iten.information}}</view>
						</view>
						...
						<view class="hui_zhuiwen"  v-if="iten.type==2">
							...
							<view class="hui_zhuiwen_body">{{iten.information}}</view>
						</view>
						</view>	
